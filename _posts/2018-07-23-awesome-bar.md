...
{% include img.html url="/assets/posts/awesome-bar/bar.png" description="The Firefox URL bar with some suggestions based on the browsing history" style="margin-top:0" %}
