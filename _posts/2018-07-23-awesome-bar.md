...
{% include img.html url="awesome-bar/bar.png" description="The Firefox URL bar with some suggestions based on the browsing history" style="margin-top:0" %}
...
{% include img.html url="awesome-bar/svm-loss.png" description="A visualization of the SVM loss when adapted for ranking" width="500" %}
...
{% include img.html url="awesome-bar/loss-smooth5.png" description="The reported loss over time" %}
...
{% include img.html url="awesome-bar/pings-over-time.png" description="The number of pings sent by clients over time" %}
